...
class wsdl extends nusoap_base
{
    ...
    public function webDescription()
    {
        ...
        <div class=content>
            ...
            <div class=nav>
                <p>View the <a href="' . $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] .$_SERVER["REQUEST_URI"].'?wsdl">WSDL</a> for the service.
                Click on an operation name to view it&apos;s details.</p>
                <ul>';
                /*
                jrodriguez se cambia para tomar bien la ruta de WSDL
