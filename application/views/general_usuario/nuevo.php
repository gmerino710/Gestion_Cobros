...
foreach ($relacion as $val_rela) {
                    ?>
                                <option value="<?php echo $val_rela[$value['relacion']['id_tabla_relacion']]; ?>"><?php echo $val_rela[$value['relacion']['campo_descripcion']]; ?></option>
                                <?php
}
                ?>
                        </select>
                ...
                ?>
                     <div class="form-group">
                            ...
                            <div class="input-group date">
                              ...
                              <input type="text" class="form-control pull-right datepicker"  name="<?php echo $value['nombre']; ?>" id="<?php echo $value['nombre']; ?>" value="<?php echo set_value($value['nombre']); ?>" />
                            </div>
                        </div>
                    <?php
break;
                ...
                ?>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control"  data-inputmask='"mask": "99:99:99"' data-mask="" name="<?php echo $value['nombre']; ?>" id="<?php echo $value['nombre']; ?>" value="<?php echo set_value($value['nombre']); ?>" />
                            </div>
                            <!-- /.input group -->
                        <?php
break;
