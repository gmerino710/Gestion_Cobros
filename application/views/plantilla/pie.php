  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
      <!--
      Para ver mas opciones a la derecha
...
foreach ($this->js as $key => $value) {
    ?>
  <script src="<?php echo base_url(); ?>asset/dist/js/pages/<?php echo $value; ?>"></script>
  <?php
}
?>
...
<script>
   ...
   $('form').submit(function(event) {
      $('.carga_pagina_loading').fadeIn('fast', function() {
...
<?php
foreach ($this->scripts_pie as $key => $value) {
    $this->load->view($value['vista'], $value['datos']);
}
?>
