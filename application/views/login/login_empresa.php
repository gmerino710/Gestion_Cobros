...
<head>
    ...
    <title>Sistema Web de monitoreo de transacciones y administracion de listas</title>
...
<body class="hold-transition login-page">
    ...
    <div class="login-box">
        <div class="login-logo">
            ...
            <?php echo img(array('src' => url_logo($datos_empresa['logo']),
    'width'                                => '100%')
); ?>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            <p class="login-box-msg"><b><?php echo $datos_empresa['nombre']; ?></b></p>
            <?php
echo form_open();
?>
                <?php
